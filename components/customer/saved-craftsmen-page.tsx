...
export function SavedCraftsmenPage() {
  // Mock subset of saved craftsmen for demonstration without localStorage
  const savedCraftsmen = allCraftsmen.slice(0, 3);
        ...
        <div className="relative flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
          <div className="max-w-2xl">
            <div className="flex items-center gap-2 text-rose-600 dark:text-rose-400">
              ...
              <span className="text-xs font-bold tracking-wider uppercase">Your shortlist</span>
            </div>
          ...
          <section>
            <div className="mb-4 flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">Shortlisted craftsmen for quick access and price comparison.</p>
              </div>
