...
const initialNotifications: Notification[] = [
  ...
  { id: "profile-check", title: "Your request details are complete", detail: "Craftsmen can now see your location, preferred timing, and contact preference.", time: "4 days ago", kind: "account", unread: false, href: "/settings" },
];
    ...
    <div className="mx-auto max-w-5xl space-y-7 pb-8">
        ...
        <div className="relative flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <div className="flex items-center gap-2 text-primary">
              ...
              <span className="text-xs font-bold tracking-wider uppercase">Your inbox</span>
            </div>
          ...
          <Button variant="outline" onClick={markAllRead} disabled={!unreadCount} className="gap-2">
      ...
      <section className="overflow-hidden rounded-3xl border border-border/70 bg-card/85">
        <div className="flex flex-col gap-4 border-b border-border/60 p-5 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Button variant={showUnreadOnly ? "secondary" : "outline"} size="sm" onClick={() => setShowUnreadOnly((current) => !current)} className="gap-2 self-start sm:self-auto">
            <SlidersHorizontal className="size-3.5" /> {showUnreadOnly ? "Showing unread" : "Show unread only"}
          </Button>
        </div>
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-3 flex flex-wrap items-center gap-2">
                    ...
                    <Button asChild variant="link" size="sm" className="h-auto px-0 text-primary">
                      <Link href={notification.href}>Open details</Link>
                    </Button>
