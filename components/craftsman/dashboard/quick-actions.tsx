...
import { Briefcase, Wrench, User, Star, Bell, Images, Sparkles } from "lucide-react";

export function QuickActions() {
  const actions = [
    {
      title: "Job Requests",
      description: "Review & manage requests",
    ...
    {
      title: "My Services",
      description: "Categories & sub-services",
    ...
    },
    {
      ...
      description: "View ratings & feedback",
    ...
    {
      title: "Notifications",
      description: "Inbox & system alerts",
    ...
    },
    {
      ...
      description: "Bio, region & credentials",
      href: "/settings",
      icon: User,
    ...
    <Card className="border-border/70 bg-card">
      <CardHeader className="p-4 sm:p-5 pb-3">
        ...
        <CardDescription className="text-xs">
          Shortcuts to your workspace sections
        </CardDescription>
      </CardHeader>
