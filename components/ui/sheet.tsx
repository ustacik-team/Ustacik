...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        "fixed inset-0 z-50 bg-black/80 backdrop-blur-xs transition-opacity duration-300 ease-in-out data-[state=open]:opacity-100 data-[state=closed]:opacity-0 data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=closed]:animate-out data-[state=closed]:fade-out-0",
        className
      )}
      {...props}
    />
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        data-side={side}
        className={cn(
          "fixed z-50 flex flex-col gap-4 bg-background p-6 text-foreground shadow-2xl transition-transform duration-300 ease-in-out border-border",
          ...
          "data-[side=right]:data-[state=open]:translate-x-0 data-[side=right]:data-[state=closed]:translate-x-full",
          "data-[side=left]:data-[state=open]:translate-x-0 data-[side=left]:data-[state=closed]:-translate-x-full",
          "data-[side=top]:data-[state=open]:translate-y-0 data-[side=top]:data-[state=closed]:-translate-y-full",
          "data-[side=bottom]:data-[state=open]:translate-y-0 data-[side=bottom]:data-[state=closed]:translate-y-full",
