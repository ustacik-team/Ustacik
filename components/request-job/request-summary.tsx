  ...
  return (
    <Card className="border-border/70 bg-card/90 shadow-sm">
      ...
      <CardContent className="space-y-4 pt-5 text-sm">
        <div>
          <p className="text-xs font-medium uppercase tracking-wider text-muted-foreground">Sending to</p>
        ...
        <div className="space-y-3">
          <p className="flex items-center gap-2">
            ...
            <span className="ml-auto text-right font-medium">{craftsman.category}</span>
          </p>
          <p className="flex items-center gap-2">
            <MapPin className="size-4 text-primary" />
            <span className="text-muted-foreground">Region</span>
            <span className="ml-auto font-medium">{craftsman.region}</span>
          </p>
          <p className="flex items-center gap-2">
            <WalletCards className="size-4 text-primary" />
            <span className="text-muted-foreground">Estimated range</span>
            <span className="ml-auto font-medium">₺{craftsman.priceMin}–₺{craftsman.priceMax}</span>
          </p>
        </div>
        <Separator />
